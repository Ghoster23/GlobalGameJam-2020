...
with(tile)
{
    ...
    if (position_meeting(x,              y - img_height, self.object_index))  u = 1;
    if (position_meeting(x + img_width,  y,              self.object_index))  r = 2;
    if (position_meeting(x,              y + img_height, self.object_index))  d = 4;
    if (position_meeting(x - img_width,  y,              self.object_index))  l = 8;
    
    // Check corner existence
    if (position_meeting(x - img_height, y - img_width,  self.object_index))  ul = 1;
    if (position_meeting(x + img_height, y - img_width,  self.object_index))  ur = 2;
    if (position_meeting(x + img_height, y + img_width,  self.object_index))  dr = 4;
    if (position_meeting(x - img_height, y + img_width,  self.object_index))  dl = 8;
